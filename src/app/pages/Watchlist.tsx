        ...
        {watchlistContent.length > 0 ? (
          <>
            <p className="text-gray-400 mb-6">
              {watchlistContent.length} {watchlistContent.length === 1 ? 'item' : 'items'} in your
              watchlist
            </p>

            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
              {watchlistContent.map((item, idx) => (
                <motion.div
                  key={item.id}
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 p-2 bg-red-600 hover:bg-red-700 rounded-full opacity-0 group-hover:opacity-100 transition-all z-10"
                  >
